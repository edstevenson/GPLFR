...
For an expanded version of the exoclimate dataset, more thorough benchmarking, and the problem-specific adaptation of GPLFR, see [ThousandWorlds](https://github.com/edstevenson/ThousandWorlds) and the associated [paper](https://doi.org/10.48550/arXiv.2606.18338).
