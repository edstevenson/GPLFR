...
def main() -> None:
    ...
    fig.savefig(out_dir / "learning_curve_rmse_sig_beta0p1_z6.png", dpi=300)
    fig.savefig(out_dir / "learning_curve_rmse_sig_beta0p1_z6.pdf")
    print(f"wrote {out_dir / 'learning_curve_rmse_sig_beta0p1_z6.png'}")
    print(f"wrote {out_dir / 'learning_curve_rmse_sig_beta0p1_z6.pdf'}")
